...
| Google Apps Script | Public form receiver and email automation | Deployed `/exec` URL in `site-config.js` | Executes as owner; Version 2 acknowledgement bridge verified; source in `apps-script/` |
...
| Google mail service | Admin and visitor enquiry emails | Called by Apps Script | Administrator and visitor delivery verified; monitor quota and delivery failures |
